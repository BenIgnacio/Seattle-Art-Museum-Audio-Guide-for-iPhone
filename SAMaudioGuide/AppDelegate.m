...
@synthesize itemTableViewController = _itemTableViewController;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.itemTableViewController = [[ItemTableViewController alloc] initWithNibName:@"ItemTableViewController" bundle:nil];
    ...
    //create empty db
    //self.itemTableViewController.managedObjectContext = self.managedObjectContext;
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"SAMaudioGuide" withExtension:@"momd"];
