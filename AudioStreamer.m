...
- (void)failWithErrorCode:(AudioStreamerErrorCode)anErrorCode
{
	@synchronized(self)
	{
        ...
        //Changed err message to be more friendly. - Ben
		[self presentAlertWithTitle:NSLocalizedStringFromTable(@"File Error", @"Errors", nil)
							message:NSLocalizedStringFromTable(@"I wasn't able to start the audio. Please try again.", @"Errors", nil)];
	}
}
...
- (BOOL)openReadStream
{
	@synchronized(self)
	{
		...
		{
			//Make error alert more friendly. - Ben
            [self presentAlertWithTitle:NSLocalizedStringFromTable(@"File Error", @"Errors", nil)
								message:NSLocalizedStringFromTable(@"I wasn't able to start the audio. Please try again.", @"Errors", nil)];
			return NO;
		}
